...
export function PersonalTimeline() {
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-10 size-[36rem] rounded-full blur-3xl opacity-10 bg-radial from-accent/20 to-transparent pointer-events-none" />
      <div className="absolute bottom-1/4 right-10 size-[36rem] rounded-full blur-3xl opacity-10 bg-radial from-blue-500/20 to-transparent pointer-events-none" />
      ...
      <div className="relative max-w-[1600px] mx-auto">
        ...
        <div className="mb-16 max-w-5xl">
          ...
          <div className="mt-8 p-6 md:p-8 rounded-2xl border border-white/10 bg-[#14161C]/80 backdrop-blur-xl shadow-xl">
        ...
        <div className="mb-20 p-6 rounded-2xl border border-white/10 bg-[#14161C]/60 backdrop-blur-md">
          <div className="flex items-center gap-2 mb-4 font-mono text-[10px] uppercase tracking-widest text-accent">
                ...
                <span
                  className={`px-3 py-1.5 rounded-lg border ${
                    idx === JOURNEY_STEPS.length - 1
                      ? "border-accent bg-accent/15 text-accent font-bold shadow-[0_0_15px_rgba(232,168,56,0.3)]"
          ...
          {CHAPTERS.map((m, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute left-8 md:left-1/2 -translate-x-1/2 size-14 rounded-2xl border border-accent/40 bg-[#14161C] flex items-center justify-center text-accent shadow-[0_0_24px_rgba(232,168,56,0.35)] z-20">
                ...
                <div className="w-full md:w-[calc(50%-3.5rem)] ml-16 md:ml-0">
                  <div
                    className={`p-8 md:p-10 rounded-2xl border border-white/10 bg-gradient-to-b from-[#14161C]/95 to-[#0F1116] backdrop-blur-xl shadow-xl transition-all duration-300 group ${m.borderColor}`}
                  >
                    {/* Chapter & Tag */}
                    ...
                    {/* Title & Subtitle */}
                    <h3 className="font-display text-2xl sm:text-3xl font-bold tracking-tight text-foreground group-hover:text-accent transition-colors mb-1">
                      {m.title}
                    </h3>
                    ...
                    {m.keyPrinciple && (
                      <div className="mb-6 p-4 rounded-xl border border-accent/30 bg-accent/10 font-mono text-xs text-accent">
                        <span className="uppercase tracking-widest text-[9px] block text-accent/70 mb-1">
                          OPERATING PRINCIPLE
                        </span>
                    ...
                    {m.inquiries && (
                      <div className="mb-6 p-5 rounded-xl border border-blue-500/25 bg-blue-500/5 space-y-2.5">
                        <span className="font-mono uppercase tracking-widest text-[10px] text-blue-400 block font-semibold">
                    ...
                    {m.formula && (
                      <div className="mb-6 p-4 rounded-xl border border-emerald-500/25 bg-emerald-500/5">
                        <span className="font-mono uppercase tracking-widest text-[10px] text-emerald-400 block mb-1 font-semibold">
        ...
        <div className="mt-20 relative rounded-3xl border border-white/15 bg-gradient-to-br from-[#14161C] via-[#101217] to-[#0A0C10] p-8 md:p-14 shadow-2xl overflow-hidden">
          <div className="absolute -top-20 -right-20 size-80 bg-radial from-accent/15 to-transparent blur-3xl pointer-events-none" />
