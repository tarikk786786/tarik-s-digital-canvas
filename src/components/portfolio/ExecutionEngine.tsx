...
const JOURNEY_STEPS = [
  {
    ...
    telemetry: "Mode: Deep Research · Source: First Principles",
    color: "#62E6FF",
  },
  {
    phase: "BUILD",
    ...
    telemetry: "Output: Working Software · Method: Iterative",
    color: "#F6C85F",
  },
  {
    phase: "TEST",
    ...
    telemetry: "Approach: Adversarial · Coverage: Edge Cases",
    color: "#FF7070",
  },
  {
    phase: "FAIL",
    ...
    telemetry: "Response: Log & Analyze · Panic: Zero",
    color: "#F6C85F",
  },
  {
    phase: "UNDERSTAND",
    ...
    telemetry: "Method: Root-Cause Analysis · Depth: Full Stack",
    color: "#9B8CFF",
  },
  {
    phase: "IMPROVE",
    ...
    telemetry: "Result: Hardened System · Cycle: Continuous",
    color: "#6EE7B7",
  },
];
...
const FAILURE_DATA_LOGS = [
  {
    ...
    gain: "Deterministic state sync · No data loss",
  ...
  },
  {
    ...
    gain: "Stable frame rate · No memory drift",
    status: "RESOLVED & HARDENED",
  },
  {
    id: "ANOMALY-301",
    ...
    gain: "Source-grounded output · Citation-verified",
    status: "RESOLVED & HARDENED",
  },
  {
    id: "ANOMALY-204",
...
const OS_ROUTINES = [
  ...
  },
  {
    ...
    metric: "Signal: Root Cause Found",
  },
  {
    command: "IMPROVE()",
